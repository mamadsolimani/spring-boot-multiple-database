...
public class BranchDBConfig {
	...
	public PlatformTransactionManager branchTransactionManager(@Qualifier("bookingEntityManager") EntityManagerFactory entityManagerFactory) {
